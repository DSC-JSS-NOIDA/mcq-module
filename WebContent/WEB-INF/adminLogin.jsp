...
<body background="static/images/adminbg.jpg">
	<!-- background image for the admin portal -->
	<div style="height: 90px" id="header_footer">
		<img src="static/images/gdgjsslogoblack.png" class="left">
		<!-- project logo comes here -->
		<img src="static/images/adminlogo.png" class="right"
			style="width: 200px; height: 200px; margin: 10px">
	</div>
	<form action="/gdgmcq/AdminLoginController.html" method="post">
					...
					<div class="row">
						<div class="input-field col s12">
							<i class="material-icons prefix ">account_circle</i> <input
								id="icon_prefix" type="text" name="username" class="validate"> <label
