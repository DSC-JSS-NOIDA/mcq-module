...
<link rel="stylesheet" href="static/css/materialize.css" type="text/css"
	...
	<title>Galvatron Intercepter</title>
</head>
<body background="static/images/quesbg.jpg">
	...
	<br/>
	<br/>
	<h5 class="center-align blue-grey-text text-darken-3">On account of
		forbidden event trigger, your session has expired, click to return to Home
		Page.<br> Contact team GDG for further assistance.</h5>
	<br/>
	<div align="center">
